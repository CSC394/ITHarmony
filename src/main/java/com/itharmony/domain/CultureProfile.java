...
public class CultureProfile implements Serializable {
    ...
    public Integer getGroupWork() {
        return groupWork;
    }

    public CultureProfile groupWork(Integer groupWork) {
        this.groupWork = groupWork;
        return this;
    }

    public void setGroupWork(Integer groupWork) {
        this.groupWork = groupWork;
    }
    ...
    public CultureProfile userProfileExtra(UserProfileExtra userProfileExtra) {
