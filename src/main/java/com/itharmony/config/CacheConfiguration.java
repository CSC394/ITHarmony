...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName(), jcacheConfiguration);
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName() + ".candidateEducations", jcacheConfiguration);
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName() + ".candidateWorkExperiences", jcacheConfiguration);
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName() + ".skillsProfiles", jcacheConfiguration);
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName() + ".jobPosts", jcacheConfiguration);
            cm.createCache(com.itharmony.domain.UserProfileExtra.class.getName() + ".jobMatches", jcacheConfiguration);
