...
public class CultureProfileResourceIntTest {
    ...
    private static final Integer DEFAULT_GROUPS = 1;
    private static final Integer UPDATED_GROUPS = 2;
    ...
    public void createCultureProfile() throws Exception {
        ...
        assertThat(testCultureProfile.getGroups()).isEqualTo(DEFAULT_GROUPS);
    ...
    public void updateCultureProfile() throws Exception {
        ...
        assertThat(testCultureProfile.getGroups()).isEqualTo(UPDATED_GROUPS);
