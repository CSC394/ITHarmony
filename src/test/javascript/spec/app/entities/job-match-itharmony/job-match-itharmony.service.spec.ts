...
describe('Service Tests', () => {
    ...
    describe('JobMatchItharmony Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(JobMatchItharmonyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/job-matches';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return JobMatchItharmony', () => {
