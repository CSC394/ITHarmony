...
describe('Service Tests', () => {
    ...
    describe('CultureProfileItharmony Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CultureProfileItharmonyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/culture-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CultureProfileItharmony', () => {
