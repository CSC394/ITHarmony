...
describe('Service Tests', () => {
    ...
    describe('CandidateWorkExperienceItharmony Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CandidateWorkExperienceItharmonyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidate-work-experiences';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CandidateWorkExperienceItharmony', () => {
