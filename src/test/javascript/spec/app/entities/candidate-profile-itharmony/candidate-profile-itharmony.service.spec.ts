...
describe('Service Tests', () => {
    ...
    describe('CandidateProfileItharmony Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CandidateProfileItharmonyService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidate-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CandidateProfileItharmony', () => {
